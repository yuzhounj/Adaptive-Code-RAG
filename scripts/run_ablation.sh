...
run_top_k() {
    echo ""
    echo "########## Ablation: top_k ##########"
    run_experiment "top_k_2" retriever.top_k=2 rl.eval_metric_top_k=2
    run_experiment "top_k_3" retriever.top_k=3 rl.eval_metric_top_k=2
    run_experiment "top_k_5" retriever.top_k=5 rl.eval_metric_top_k=2
}
